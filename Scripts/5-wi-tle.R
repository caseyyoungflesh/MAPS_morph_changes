####################
# Changes in wing idx over time/lat/elev
#
####################
...
MCMCvis::MCMCdiag(fit, 
                  round = 4,
                  file_name = paste0('wi-tle-results-', run_date),
                  dir = paste0(dir, '/Results'),
                  mkdir = paste0('wi-tle-', run_date),
                  probs = c(0.055, 0.5, 0.945),
                  pg0 = TRUE,
                  save_obj = TRUE,
                  obj_name = paste0('wi-tle-fit-', run_date),
                  add_obj = list(DATA, ppc_sim),
                  add_obj_names = c(paste0('wi-tle-data-', run_date),
                                    paste0('wi-ppc-sim-', run_date)),
                  cp_file = c('Model_files/morph-tle.stan', 
                              '5-wi-tle.R'),
                  cp_file_names = c(paste0('morph-tle-', run_date, '.stan'),
                                    paste0('4-wi-tle-', run_date, '.R')))


# PPO ---------------------------------------------------------------------

#create dir for figs if doesn't exist
ifelse(!dir.exists(paste0(dir, 'Results/wi-tle-', run_date, '/Figures')),
       dir.create(paste0(dir, 'Results/wi-tle-', run_date, '/Figures')),
       FALSE)

setwd(paste0(dir, 'Results/wi-tle-', run_date, '/Figures'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-mu_gamma-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-mu_theta-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-mu_eta-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-sigma_beta-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-sigma_gt[1]-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-sigma_gt[2]-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-sigma_eta-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-lambda_xi-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-kappa_xi-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-lambda_proc-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-kappa_proc-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-mu_alpha-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-sigma_alpha-', run_date, '.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   pdf = TRUE,
                   open_pdf = FALSE,
                   filename = paste0('wi-tle-trace-nu-', run_date, '.pdf'))
